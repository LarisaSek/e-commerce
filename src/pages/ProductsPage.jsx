...
const ProductPage = () => {
    ...
    return (
        <div className="product-page">
            {/* :white_check_mark: Product Image on the Left */}
            <div className="product-image">
                <img src={product.image} alt={product.title} />
            </div>
            {/* :white_check_mark: Product Details on the Right */}
            <div className="product-info">
                <h2>{product.title}</h2>
                <p className="category">Category: {product.category}</p>
                {/* :white_check_mark: Styled Price */}
                <p className="price">{product.price.toFixed(2)} kr</p>
                {/* :white_check_mark: Quantity Selector */}
                ...
                {/* :white_check_mark: Add to Cart Button */}
                <button
                ...
                {/* :white_check_mark: Product ID (optional) */}
